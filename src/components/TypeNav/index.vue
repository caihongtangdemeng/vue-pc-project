    ...
    <div class="container">
      ...
      <div class="sort" @mouseleave="currentIndex=-1">
        <div class="all-sort-list2">
          <div class="item" v-for="(c1,index) in categoryList" :key="c1.categoryId" :class="{item_on:index===currentIndex}" @mouseenter="currentIndex=index"
          >
            <h3>
...
export default {
  ...
  mounted(){ //触发vuex中的getBaseCategoryList  actions调用
